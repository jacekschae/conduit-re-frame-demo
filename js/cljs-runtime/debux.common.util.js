...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27844_SHARP_){
return !(cljs.core.contains_QMARK_(result,p1__27844_SHARP_));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27843_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27843_SHARP_),"#"].join('');
...
return (((p1__27845_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__27845_SHARP_) == null)));
});})(gen_name,name_for))
 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__27848,mapping){
...
var state = map__27849__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27849__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27849__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27849__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__27849,map__27849__$1,state,context,refers,aliases){
...
});})(map__27849,map__27849__$1,state,context,refers,aliases))
,mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (map__27849,map__27849__$1,state,context,refers,aliases){
return (function (p1__27846_SHARP_){
var and__3911__auto__ = (p1__27846_SHARP_ instanceof cljs.core.Symbol);
if(and__3911__auto__){
return cljs.core.namespace(p1__27846_SHARP_);
} else {
...
var G__27851 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__27852 = clojure.zip.next(loc);
loc = G__27852;
continue;
}
}
...
debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__27858){
var vec__27859 = p__27858;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27859,(0),null);
...
/** @this {Function} */
debux.common.util.form_header.cljs$lang$applyTo = (function (seq27856){
var G__27857 = cljs.core.first(seq27856);
var seq27856__$1 = cljs.core.next(seq27856);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27857,seq27856__$1);
});

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__27865_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27865_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR_27867_27869 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_27868_27870 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_27867_27869,_STAR_print_fn_STAR_27868_27870,sb__4430__auto__,res){
return (function (x__4431__auto__){
return sb__4430__auto__.append(x__4431__auto__);
});})(_STAR_print_newline_STAR_27867_27869,_STAR_print_fn_STAR_27868_27870,sb__4430__auto__,res))
;

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_27868_27870;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_27867_27869;
}
...
return debux.common.util.prepend_bars(p1__27866_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__27873 = cljs.core.next(opts__$1);
var G__27874 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__27873;
acc = G__27874;
continue;
} else {
if(typeof f === 'string'){
var G__27875 = cljs.core.next(opts__$1);
var G__27876 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__27875;
acc = G__27876;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__27877 = cljs.core.nnext(opts__$1);
var G__27878 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__27877;
acc = G__27878;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__27879 = cljs.core.next(opts__$1);
var G__27880 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__27879;
acc = G__27880;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__27871 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__27871.cljs$core$IFn$_invoke$arity$1 ? fexpr__27871.cljs$core$IFn$_invoke$arity$1(f) : fexpr__27871.call(null,f));
})())){
var G__27881 = cljs.core.next(opts__$1);
var G__27882 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__27881;
acc = G__27882;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__27872 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__27872.cljs$core$IFn$_invoke$arity$1 ? fexpr__27872.cljs$core$IFn$_invoke$arity$1(f) : fexpr__27872.call(null,f));
})())){
var G__27883 = cljs.core.nnext(opts__$1);
var G__27884 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__27883;
acc = G__27884;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__27885 = cljs.core.next(opts__$1);
var G__27886 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__27885;
acc = G__27886;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__27887){
...
var G__27893 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__27892 = (function (){var fexpr__27894 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__27894.cljs$core$IFn$_invoke$arity$1 ? fexpr__27894.cljs$core$IFn$_invoke$arity$1(form) : fexpr__27894.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__27896 = quoted_form;
var G__27897 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__27896,G__27897) : debux.common.util.remove_d.call(null,G__27896,G__27897));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__27898 = quoted_form;
var G__27899 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__27898,G__27899) : debux.common.util.remove_d.call(null,G__27898,G__27899));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__27902__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__27900 = quoted_form;
var G__27901 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__27900,G__27901) : debux.common.util.remove_d.call(null,G__27900,G__27901));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__27903__i < G__27903__a.length) {G__27903__a[G__27903__i] = arguments[G__27903__i + 0]; ++G__27903__i;}
  arg = new cljs.core.IndexedSeq(G__27903__a,0,null);
} 
return G__27902__delegate.call(this,arg);};
G__27902.cljs$lang$maxFixedArity = 0;
G__27902.cljs$lang$applyTo = (function (arglist__27904){
var arg = cljs.core.seq(arglist__27904);
return G__27902__delegate(arg);
});
...
var G__27905 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__27905;
continue;
} else {
...
var G__27906 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__27906;
continue;
} else {
var G__27907 = clojure.zip.next(loc);
loc = G__27907;
continue;
