...
if((function (){var and__3911__auto__ = cljs.core.coll_QMARK_(z);
...
var or__3922__auto__ = zprint.core.rewrite_clj_zipper_QMARK_(z);
...
var vec__30340 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__30343 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30343,(0),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30340,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30340,(1),null);
...
var fzprint_fn = cljs.core.partial.cljs$core$IFn$_invoke$arity$4(zprint.zprint.fzprint,options__$2,(cljs.core.truth_((function (){var and__3911__auto__ = new cljs.core.Keyword(null,"file?","file?",1755223728).cljs$core$IFn$_invoke$arity$1(options__$2);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__30346){
var vec__30347 = p__30346;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30347,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30347,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30350,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30350,(1),null);
...
var auto_width = (cljs.core.truth_((function (){var and__3911__auto__ = cljs.core.not(width);
if(and__3911__auto__){
...
var vec__30354 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30354,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30354,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30354,(2),null);
var vec__30357 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30357,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30357,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30357,(2),null);
...
var G__30360 = special_option;
var G__30360__$1 = (((G__30360 instanceof cljs.core.Keyword))?G__30360.fqn:null);
switch (G__30360__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__30362){
var vec__30363 = p__30362;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30363,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30363,(1),null);
...
var vec__30369 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30369,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30369,(1),null);
...
var G__30372 = zprint.core.parse_string_all_options(rest_options);
var G__30373 = zprint.core.czprint_str_internal;
var G__30374 = ":parse-string-all? call";
var G__30375 = (function (){var G__30376 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__30376) : zprint.zutil.edn_STAR_.call(null,G__30376));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__30372,G__30373,G__30374,G__30375) : zprint.core.process_multiple_forms.call(null,G__30372,G__30373,G__30374,G__30375));
} else {
throw (new Error([":parse-string-all? requires a string!"].join('')));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__30377 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30377,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30377,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq30366){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30367,G__30368,seq30366__$2);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq30385){
var G__30386 = cljs.core.first(seq30385);
var seq30385__$1 = cljs.core.next(seq30385);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30386,seq30385__$1);
});
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq30390){
...
var args__4502__auto__ = [];
var len__4499__auto___30397 = arguments.length;
var i__4500__auto___30398 = (0);
while(true){
if((i__4500__auto___30398 < len__4499__auto___30397)){
args__4502__auto__.push((arguments[i__4500__auto___30398]));

var G__30399 = (i__4500__auto___30398 + (1));
i__4500__auto___30398 = G__30399;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq30395){
var G__30396 = cljs.core.first(seq30395);
var seq30395__$1 = cljs.core.next(seq30395);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30396,seq30395__$1);
});
...
args__4502__auto__.push((arguments[i__4500__auto___30403]));
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq30400){
var G__30401 = cljs.core.first(seq30400);
var seq30400__$1 = cljs.core.next(seq30400);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30401,seq30400__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__30406,form){
var vec__30407 = p__30406;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30407,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30407,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30407,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30407,(3),null);
...
var vec__30410 = (cljs.core.truth_((function (){var and__3911__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__3911__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30410,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30410,(1),null);
...
var drop_QMARK_ = !(cljs.core.not((function (){var and__3911__auto__ = space_count;
if(cljs.core.truth_(and__3911__auto__)){
var and__3911__auto____$1 = !(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"skip","skip",602715391),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(next_options__$1)));
if(and__3911__auto____$1){
...
var output_str = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"off","off",606440789),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(decision_options))) || (((cljs.core.not((function (){var or__3922__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [((local_QMARK_)?zprint.config.merge_deep.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([next_options__$1,new_options], 0)):(cljs.core.truth_((function (){var or__3922__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
return whitespace_form_QMARK_;
...
var forms = (function (){var G__30415 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__30415) : zprint.zutil.edn_STAR_.call(null,G__30415));
})();
