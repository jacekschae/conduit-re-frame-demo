...
})())?rewrite_clj.zip.removez.remove_preceding_space(zloc,(function (p1__28918_SHARP_){
var and__3911__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_(p1__28918_SHARP_);
if(cljs.core.truth_(and__3911__auto__)){
return cljs.core.not(rewrite_clj.zip.whitespace.linebreak_QMARK_(p1__28918_SHARP_));
} else {
return and__3911__auto__;
}
})):zloc),(function (p1__28919_SHARP_){
var and__3911__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_(p1__28919_SHARP_);
if(cljs.core.truth_(and__3911__auto__)){
return cljs.core.not(rewrite_clj.zip.whitespace.linebreak_QMARK_(p1__28919_SHARP_));
} else {
return and__3911__auto__;
}
}))));
