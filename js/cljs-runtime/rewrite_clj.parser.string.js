...
if((c === "\n")){
var G__28628 = escape_QMARK_;
var G__28629 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__28628;
lines = G__28629;
continue;
} else {
buf.append(c);

var G__28630 = ((!(escape_QMARK_)) && ((c === "\\")));
var G__28631 = lines;
escape_QMARK_ = G__28630;
lines = G__28631;
continue;
...
var G__28632 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__28632) : rewrite_clj.node.string_node.call(null,G__28632));
});
...
var G__28638 = cljs.core.re_pattern(regex);
var G__28639 = ["#\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(regex),"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__28638,G__28639) : rewrite_clj.node.token_node.call(null,G__28638,G__28639));
});
