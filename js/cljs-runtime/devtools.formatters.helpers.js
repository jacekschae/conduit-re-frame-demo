...
var G__33234 = devtools.prefs.pref(v);
v = G__33234;
continue;
} else {
return v;
...
}catch (e33237){var _e__31502__auto__ = e33237;
return false;
}})();
...
}catch (e33241){var _e__31502__auto__ = e33241;
return false;
}})();
...
}catch (e33243){var _e__31502__auto__ = e33243;
return false;
}}
}
});
...
var vec__33245 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__33248_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__33248_SHARP_);
}),template);
});
