...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__29667_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__29667_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__29667_SHARP_) <= ending)));
}));
});
...
var G__29684 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__29696_SHARP_);
});})(and__3911__auto__))
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__29710_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__29710_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__29714){
var vec__29715 = p__29714;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29715,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29715,(1),null);
...
var new_state = (function (){var G__29723 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,reaction_id,((function (G__29723,G__29723__$1,tags,reaction_id,state){
...
});})(G__29723,G__29723__$1,tags,reaction_id,state))
);
...
return (function (all_state,p__29726){
var vec__29727 = p__29726;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29727,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29727,(1),null);
