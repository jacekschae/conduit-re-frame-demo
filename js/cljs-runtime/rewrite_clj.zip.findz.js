...
var len__4499__auto___28915 = arguments.length;
var i__4500__auto___28916 = (0);
while(true){
if((i__4500__auto___28916 < len__4499__auto___28915)){
args__4502__auto__.push((arguments[i__4500__auto___28916]));

var G__28917 = (i__4500__auto___28916 + (1));
i__4500__auto___28916 = G__28917;
continue;
} else {
}
break;
...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__28911){
var vec__28912 = p__28911;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28912,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__28912,additional){
...
;})(vec__28912,additional))
} else {
return ((function (vec__28912,additional){
return (function (p1__28908_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__28908_SHARP_),t);
});
;})(vec__28912,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq28909){
var G__28910 = cljs.core.first(seq28909);
var seq28909__$1 = cljs.core.next(seq28909);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28910,seq28909__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__28920,p__28921){
var map__28922 = p__28920;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28922__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28922__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28922__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28922__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__28923 = p__28921;
var map__28923__$1 = ((((!((map__28923 == null)))?(((((map__28923.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28923.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28923):map__28923);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28923__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28923__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__28931_SHARP_){
var and__3911__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__28931_SHARP_) : p_QMARK_.call(null,p1__28931_SHARP_));
if(cljs.core.truth_(and__3911__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__28931_SHARP_)),pos);
} else {
return and__3911__auto__;
}
...
var G__28937 = zloc;
var G__28937__$1 = (((G__28937 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__28937) : f.call(null,G__28937)));
if((G__28937__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__28937__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__28939_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__28939_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__28948_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__28948_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__28968_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__28968_SHARP_),v);
}));
