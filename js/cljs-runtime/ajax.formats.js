...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__41016){
...
var request = map__41017__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41017__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__41039 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__41039.cljs$core$IFn$_invoke$arity$1 ? fexpr__41039.cljs$core$IFn$_invoke$arity$1(response) : fexpr__41039.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__41042 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__41042.cljs$core$IFn$_invoke$arity$1 ? fexpr__41042.cljs$core$IFn$_invoke$arity$1(response) : fexpr__41042.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__41052){
var map__41057 = p__41052;
var map__41057__$1 = ((((!((map__41057 == null)))?(((((map__41057.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41057.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41057):map__41057);
var request = map__41057__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41057__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
