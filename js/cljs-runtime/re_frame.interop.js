...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__38062 = cljs.core.instance_QMARK_;
var expr__38063 = reactive_val;
if(cljs.core.truth_((pred__38062.cljs$core$IFn$_invoke$arity$2 ? pred__38062.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__38063) : pred__38062.call(null,reagent.ratom.RAtom,expr__38063)))){
return "ra";
} else {
if(cljs.core.truth_((pred__38062.cljs$core$IFn$_invoke$arity$2 ? pred__38062.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__38063) : pred__38062.call(null,reagent.ratom.RCursor,expr__38063)))){
return "rc";
} else {
if(cljs.core.truth_((pred__38062.cljs$core$IFn$_invoke$arity$2 ? pred__38062.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__38063) : pred__38062.call(null,reagent.ratom.Reaction,expr__38063)))){
return "rx";
} else {
if(cljs.core.truth_((pred__38062.cljs$core$IFn$_invoke$arity$2 ? pred__38062.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__38063) : pred__38062.call(null,reagent.ratom.Track,expr__38063)))){
return "tr";
} else {
return "other";
}
