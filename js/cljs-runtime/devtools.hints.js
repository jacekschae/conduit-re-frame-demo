...
var G__31575 = cljs.core.PersistentArrayMap.EMPTY;
var G__31576 = native_stack_trace;
var G__31577 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__31578 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__31575,G__31576,G__31577,G__31578) : cljs.stacktrace.parse_stacktrace.call(null,G__31575,G__31576,G__31577,G__31578));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31580__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31580__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31580__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e31579){var _e = e31579;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___31588 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___31588)){
var seen_errors_31589 = temp__5455__auto___31588;
if(cljs.core.truth_(seen_errors_31589.has(self))){
} else {
seen_errors_31589.add(self);

var temp__5457__auto___31590 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___31590)){
var sense_31591 = temp__5457__auto___31590;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_31591)].join('');
} else {
}
}
} else {
