...
var G__29037 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__29037__$1 = (((G__29037 == null))?null:cljs.core.iterate(((function (G__29037,n0,temp__5455__auto__){
return (function (loc){
...
});})(G__29037,n0,temp__5455__auto__))
,G__29037));
var G__29037__$2 = (((G__29037__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__29037__$1));
var G__29037__$3 = (((G__29037__$2 == null))?null:cljs.core.last(G__29037__$2));
if((G__29037__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__29037__$3);
}
} else {
return zloc;
}
...
var G__29046 = rewrite_clj.zip.move.right(v);
var G__29047 = rewrite_clj.zip.move.up(v);
loc = G__29046;
parent = G__29047;
continue;
} else {
var G__29048 = rewrite_clj.zip.move.right(v0);
var G__29049 = parent;
loc = G__29048;
parent = G__29049;
continue;
...
var G__29050 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__29051 = rewrite_clj.zip.move.up(v);
loc = G__29050;
parent = G__29051;
continue;
} else {
var G__29052 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__29053 = parent;
loc = G__29052;
parent = G__29053;
continue;
...
if(cljs.core.truth_(rewrite_clj.zip.seqz.map_QMARK_(zloc))){
var G__29054 = zloc;
var G__29054__$1 = (((G__29054 == null))?null:rewrite_clj.zip.move.down(G__29054));
var G__29054__$2 = (((G__29054__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__29054__$1,k));
if((G__29054__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__29054__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__29055 = rewrite_clj.zip.move.down(zloc);
var G__29055__$1 = (((G__29055 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__29055));
if((G__29055__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__29055__$1);
}
})(),k);
}
});
