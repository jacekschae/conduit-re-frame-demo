...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__41408){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41409__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3922__auto__ = p1__41419_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__41420){
var map__41421 = p__41420;
var map__41421__$1 = ((((!((map__41421 == null)))?(((((map__41421.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41421.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41421):map__41421);
var request = map__41421__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41421__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
