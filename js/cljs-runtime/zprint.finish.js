...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__28986_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28986_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__28986_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__28987){
var vec__28988 = p__28987;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28988,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28988,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__28991,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28992__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28992__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28992__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__28996 = (function (){var or__3922__auto__ = color;
...
var fexpr__28995 = (function (){var G__28997 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
var and__3911__auto____$1 = zprint.finish.within_QMARK_(idx,focus);
if(cljs.core.truth_(and__3911__auto____$1)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"indent","indent",-148200125));
} else {
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__28997) : style_map.call(null,G__28997));
})();
return (fexpr__28995.cljs$core$IFn$_invoke$arity$1 ? fexpr__28995.cljs$core$IFn$_invoke$arity$1(G__28996) : fexpr__28995.call(null,G__28996));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__28998){
var vec__28999 = p__28998;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28999,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28999,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28999,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__29002){
var vec__29003 = p__29002;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29003,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29003,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29003,(2),null);
...
if(doing_nil_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),(function (){var or__3922__auto__ = last_elide;
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
var G__29006 = cljs.core.next(ssv);
var G__29007 = (this_ssv == null);
var G__29008 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
...
var vec__29010 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29010,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29010,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29010,(2),null);
...
var G__29013 = cljs.core.next(remaining_cvec);
var G__29014 = new_idx;
var G__29015 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__29013;
idx = G__29014;
out = G__29015;
continue;
}
...
var G__29022 = cljs.core.next(ss_vec);
...
var G__29024 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__29025 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__29022;
current = G__29023;
pos = G__29024;
out = G__29025;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__29026,cursor_vec){
var vec__29027 = p__29026;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29027,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29027,(1),null);
var focus_vec = vec__29027;
...
var vec__29030 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29030,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29030,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__29033){
var vec__29034 = p__29033;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29034,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29034,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__29041,existing_count){
var vec__29042 = p__29041;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29042,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29042,(1),null);
...
var vec__29056 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29056,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29056,(1),null);
var cvec_element = vec__29056;
if((cvec_element == null)){
var G__29059 = cljs.core.next(cvec_nl);
var G__29060 = (idx + (1));
var G__29061 = start;
var G__29062 = out;
cvec_nl = G__29059;
...
if(cljs.core.truth_((function (){var and__3911__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(1));
...
var G__29063 = cljs.core.next(cvec_nl);
var G__29064 = (idx + (1));
var G__29065 = idx;
var G__29066 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__29063;
idx = G__29064;
start = G__29065;
out = G__29066;
...
var G__29067 = cljs.core.next(cvec_nl);
var G__29068 = (idx + (1));
var G__29069 = (idx + (1));
var G__29070 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__29067;
idx = G__29068;
start = G__29069;
out = G__29070;
...
var G__29071 = cljs.core.next(cvec_nl);
var G__29072 = (idx + (1));
var G__29073 = idx;
var G__29074 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__29071;
idx = G__29072;
start = G__29073;
out = G__29074;
...
var G__29075 = cljs.core.next(cvec_nl);
var G__29076 = (idx + (1));
var G__29077 = start;
var G__29078 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__29075;
idx = G__29076;
start = G__29077;
out = G__29078;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__29080_SHARP_,p2__29079_SHARP_){
if(cljs.core.truth_(zprint.finish.within_QMARK_(idx,p2__29079_SHARP_))){
return cljs.core.reduced(p1__29080_SHARP_);
} else {
return (p1__29080_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__29081,p__29082){
var vec__29083 = p__29081;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29083,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29083,(1),null);
var vec__29086 = p__29082;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29086,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29086,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__29090,cvec,focus_vec){
...
var map__29092 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29091__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29092__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29092__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29092__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__29091,map__29091__$1,options,map__29092,map__29092__$1,focus,lines,paths){
return (function (p1__29089_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__29089_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__29091,map__29091__$1,options,map__29092,map__29092__$1,focus,lines,paths))
,path_vecs);
